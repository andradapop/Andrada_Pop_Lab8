...
namespace Andrada_Pop_Lab8.Models
{
    public class BookCategoriesPageModel : PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Andrada_Pop_Lab8Context context, Book book)  //8 SAU 9???
        {
        ...
        public void UpdateBookCategories(Andrada_Pop_Lab8Context context, string[] selectedCategories, Book bookToUpdate)
        {
